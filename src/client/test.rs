...
*/
  ...
  //builder.connect_raw()
  let (client, connection) = tokio_postgres::connect("postgresql://doadmin:tf45h3hpz6xstby6@db-postgresql-dev-sgp1-32064-do-user-7964287-0.b.db.ondigitalocean.com:25060/defaultdb?sslmode=require", tls).await?;
