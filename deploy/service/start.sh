...
export DB_CERT_PATH="/usr/local/bin/cert.cer"
export DB_CONN_STRING="postgresql://doadmin:tf45h3hpz6xstby6@db-postgresql-dev-sgp1-32064-do-user-7964287-0.b.db.ondigitalocean.com:25060/defaultdb?sslmode=require"
